...
class EC_Model(object):
    ...
    def get_credit_month(date_begin, date_end,businessAppId):
        ...
        sum(CASE WHEN rcLevel !='CR6' AND version !=1 THEN highestAmount ELSE 0 END ),
        sum(CASE WHEN rcLevel !='CR6' AND version !=1 THEN reviseHighestAmount ELSE 0 END ),
        COUNT(DISTINCT(CASE WHEN rcLevel !='CR6' AND version !=1 THEN enterpriseId ELSE 0 END)) AS modelPass,
        COUNT(DISTINCT(CASE WHEN rcLevel ='CR6' AND version !=1 THEN enterpriseId ELSE 0 END)) AS modelReject
